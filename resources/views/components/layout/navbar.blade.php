<div x-data="{ open1: false, open2: false, open: false}" >
    <div class="bg-white">
    <!--
        Mobile menu
    ...
    -->
    <div x-show="open" x-cloak @click.away="open = false" class="relative z-40 lg:hidden" role="dialog" aria-modal="true">
        <!--
            ...
            <div class="border-b border-gray-200">
                            ...
                            <div class="flex">
                                ...
                                <div class="fixed absolute inset-x-0 top-full">
                                    ...
                                    <div
                                        ...
                                        x-cloak
                                        @click.away="open{{ $category->id }} = false"
                                        >
                                                ...
                                                <div class="grid grid-cols-2 grid-rows-1 gap-8 text-sm">
                                                    <div class="group aspect-w-1 aspect-h-1 relative overflow-hidden rounded-md bg-gray-100 aspect-w-2 col-span-2">
                                                        ...
                                                        <div class="bg-white bg-opacity-60 p-4 text-sm">
                                                            <a href="#" class="font-medium text-gray-900">
                                                            <span class="absolute inset-0" aria-hidden="true"></span>
                                                            {{ $category->flavors()->inRandomOrder()->first()->flavor }}
                                                            </a>
                                                            <p aria-hidden="true" class="mt-0.5 text-gray-700 sm:mt-1">Shop now</p>
                                                        </div>
                                                        </div>
                ...
                <div class="flex flex-1 items-center justify-end">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::check())
                        ...
                        <div class="ml-4 flow-root lg:ml-6">
                            <a href="{{ route('logout') }}" @click.prevent="$root.submit();" class="group -m-2 flex items-center p-2">
                                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 256 256" xml:space="preserve">
                                    <defs>
                                    </defs>
