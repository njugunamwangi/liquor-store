    ...
    <div class="fixed inset-0 z-40 flex">
      ...
      <div class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
        ...
        <div class="space-y-6 border-t border-gray-200 px-4 py-6">
          ...
          <div class="flow-root">
            <a href="#" class="-m-2 block p-2 font-medium text-gray-900">Createy account</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <header class="relative overflow-hidden">
    <!-- Top navigation -->
    <nav aria-label="Top" x-data="{open1: false, open2: false}" class="relative z-20 bg-white bg-opacity-90 backdrop-blur-xl backdrop-filter">
                    ...
                    @foreach($categories as $category)
                        <div class="flex">
                            <div class="relative flex">
                                ...
                                <button @click="open{{ $category->id }} = !open{{ $category->id }}" type="button" class="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">
                                    {{ $category->category }}
                                </button>
                            </div>
                            ...
                            <div class="relative" x-cloak x-show="open{{ $category->id }}" @click.away="open{{ $category->id }} = false">
                                ...
                                <div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                                    ...
                                    <div class="row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm">
                                        @foreach($category->flavors()->inRandomOrder()->get() as $flavor)
                                        <div>
    ...
    <!-- Hero section -->
    <div class="pb-4 pt-4 sm:pb-4 sm:pt-4 lg:pb-4 lg:pt-4">
